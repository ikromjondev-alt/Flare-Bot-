...
class Moderation(commands.Cog):
    ...
    @app_commands.command(name="warn", description="Выдать предупреждение участнику (сразу с тайм-аутом 30 минут)")
    ...
    async def warn(self, interaction: discord.Interaction, member: discord.Member, reason: str):
        ...
        # Реальное наказание: каждый /warn сразу даёт тайм-аут на 30 минут
        ...
        if timeout_applied:
            embed.add_field(name="Наказание", value="⏱️ Тайм-аут на 30 минут", inline=False)
        else:
    ...
    async def unwarn(self, interaction: discord.Interaction, member: discord.Member, reason: str = "не указана"):
        ...
        # Реальное действие: снимаем активный тайм-аут, если он есть
        try:
